...
import com.kAIS.ode4j.ode.DColliderFn;
import com.kAIS.ode4j.ode.DContactGeomBuffer;
import com.kAIS.ode4j.ode.DGeom;
import com.kAIS.ode4j.ode.internal.gimpact.GimContact;
import com.kAIS.ode4j.ode.internal.gimpact.GimDynArray;
import com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.vec3f;
import com.kAIS.ode4j.ode.internal.gimpact.GimTrimeshCapsuleCollision.GIM_CAPSULE_DATA;
...
//		dIASSERT (o2.type == dCapsuleClass);
	    ...
	    //Get capsule params
	    DMatrix3C  mCapsuleRotation;
	    DVector3C   vCapsulePosition;
	    DVector3C   vCapsuleAxis = null;
	    double      vCapsuleRadius;
	    double      fCapsuleSize;
	    DMatrix3C pRot = gCylinder.getRotation();
		//memcpy(mCapsuleRotation,pRot,sizeof(dMatrix3));
	    mCapsuleRotation = pRot;//.set(pRot);
		DVector3C pDst = gCylinder.getPosition();
		//memcpy(vCapsulePosition,pDst,sizeof(dVector3));
		vCapsulePosition = pDst;//.set(pDst);
		//Axis
...
//		vCapsuleAxis[2] = mCapsuleRotation[2*4 + nCAPSULE_AXIS];
		...
		vCapsuleRadius = gCylinder.getRadius();
		fCapsuleSize = gCylinder.getLength();
		fCapsuleSize*=0.5f;
		//Set Capsule params
		GIM_CAPSULE_DATA capsule = new GIM_CAPSULE_DATA();
...
//	#endif //GIMPACT
	...
	public int dColliderFn(DGeom o1, DGeom o2, int flags,
		...
		return dCollideCCTL((DxTriMesh) o1, (DxCapsule) o2, flags, contacts, 1);
	}
