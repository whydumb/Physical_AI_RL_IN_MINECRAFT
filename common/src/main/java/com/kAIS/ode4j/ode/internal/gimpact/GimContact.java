 ...
 * ----------------------------------------------------------------------------
 */
package com.kAIS.ode4j.ode.internal.gimpact;

import static com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.VEC_ACCUM;
import static com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.VEC_COPY;
import static com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.VEC_DOT;
import static com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.VEC_NORMALIZE;
import static com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.VEC_SCALE;
import static com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.VEC_SUM;
import static com.kAIS.ode4j.ode.internal.gimpact.GimMath.GIM_SQRT;

import com.kAIS.ode4j.ode.internal.cpp4j.java.ObjArray;
import com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.vec3f;
import com.kAIS.ode4j.ode.internal.gimpact.GimGeometry.vec4f;
import com.kAIS.ode4j.ode.internal.gimpact.GimRadixSort.GIM_RSORT_TOKEN;
